...
const GetMahasiswa = () => {
    ...
    const [updateMahasiswa, setUpdateMahasiswa] = useState(null); // State untuk menangani status update
    const [isOpenUpdate, setIsOpenUpdate] = useState(false); // State untuk menangani status form update terbuka/tidak
    ...
    // Handler untuk membuka form update
    const UpdateMahasiswa = (mhs) => {
        setUpdateMahasiswa(mhs);
        setIsOpenUpdate(true);
    };

    // Handler untuk menutup form update
    const handleCloseUpdate = () => {
        setIsOpenUpdate(false);
    };

    // Handler untuk menghapus mahasiswa
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            {/* Render UpdateMahasiswa component jika form update terbuka */}
            {isOpenUpdate && (
